...
- Result: the one-seed smoke produced 10/10 runnable candidates. Luna UV fraction was `0.0300--0.0623`, energy transmission was `6.09e-7--8.44e-7`, and maximum electron density was `2.78e17--3.22e19 m^-3`. The available visual outputs are the 10-panel `luna_spectral_evolution_montage.png`, `successful_luna_final_spectra.png`, and `surrogate_vs_luna_uv_fraction.png`. This is a feasibility result, not a validated optimum.
