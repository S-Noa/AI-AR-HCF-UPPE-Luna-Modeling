...
load('../results/full_chirped_NLSE_time_256_80e.mat')
%load('../results/full_chirped_NLSE_time_256_80e_ms.mat') % examples shown in manuscript
...
ylimit = [0 0.2]; % ylim for single-shot
