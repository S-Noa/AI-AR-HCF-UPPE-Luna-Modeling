% Plot higher-order soliton (NLSE) temporal evolution

clear all; close all; clc

% 10% relative noise
load('../results/full_norm_NLSE_time_256_80e_noise10.mat')
%load('../results/full_norm_NLSE_time_256_80e_noise10_ms.mat') % examples shown in manuscript

% 20% relative noise
%load('../results/full_norm_NLSE_time_256_80e_noise20.mat')
%load('../results/full_norm_NLSE_time_256_80e_noise20_ms.mat') % examples shown in manuscript
